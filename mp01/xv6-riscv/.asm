...
void f3(void *arg)
{
   ...
   c:	1800                	addi	s0,sp,48
    ...
    while (1) {
        printf("thread 3: %d\n", i++);
   e:	6489                	lui	s1,0x2
  10:	71048593          	addi	a1,s1,1808 # 2710 <__global_pointer$+0x130f>
  14:	00001517          	auipc	a0,0x1
  18:	b9450513          	addi	a0,a0,-1132 # ba8 <thread_start_threading+0x36>
  1c:	00000097          	auipc	ra,0x0
  20:	756080e7          	jalr	1878(ra) # 772 <printf>
  24:	71148493          	addi	s1,s1,1809
  28:	00001997          	auipc	s3,0x1
  2c:	b8098993          	addi	s3,s3,-1152 # ba8 <thread_start_threading+0x36>
        if(i == 10005){
  30:	6909                	lui	s2,0x2
  32:	71590913          	addi	s2,s2,1813 # 2715 <__global_pointer$+0x1314>
            return;
            //thread_exit();
        }
        thread_yield();
  36:	00001097          	auipc	ra,0x1
  3a:	b04080e7          	jalr	-1276(ra) # b3a <thread_yield>
        printf("thread 3: %d\n", i++);
  3e:	85a6                	mv	a1,s1
...
void f2(void *arg)
{
  ...
  74:	b4850513          	addi	a0,a0,-1208 # bb8 <thread_start_threading+0x46>
  78:	00000097          	auipc	ra,0x0
  7c:	6fa080e7          	jalr	1786(ra) # 772 <printf>
  80:	4485                	li	s1,1
  82:	00001a17          	auipc	s4,0x1
  86:	b36a0a13          	addi	s4,s4,-1226 # bb8 <thread_start_threading+0x46>
        if (i == 10) {
  8a:	49a9                	li	s3,10
  ...
  94:	aaa080e7          	jalr	-1366(ra) # b3a <thread_yield>
        printf("thread 2: %d\n",i++);
...
void f1(void *arg)
{
 ...
 102:	aca50513          	addi	a0,a0,-1334 # bc8 <thread_start_threading+0x56>
 106:	00000097          	auipc	ra,0x0
 10a:	66c080e7          	jalr	1644(ra) # 772 <printf>
 10e:	06500493          	li	s1,101
 112:	00001a17          	auipc	s4,0x1
 116:	ab6a0a13          	addi	s4,s4,-1354 # bc8 <thread_start_threading+0x56>
        if (i == 110) {
 ...
 126:	a18080e7          	jalr	-1512(ra) # b3a <thread_yield>
        printf("thread 1: %d\n", i++);
...
int main(int argc, char **argv)
{
 ...
 16e:	a08080e7          	jalr	-1528(ra) # b72 <thread_start_threading>
    printf("\nexited\n");
 172:	00001517          	auipc	a0,0x1
 176:	a6650513          	addi	a0,a0,-1434 # bd8 <thread_start_threading+0x66>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4e2:	71250513          	addi	a0,a0,1810 # bf0 <digits>
 4e6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5ae:	646b8b93          	addi	s7,s7,1606 # bf0 <digits>
 ...
 6ee:	4fe90913          	addi	s2,s2,1278 # be8 <thread_start_threading+0x76>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7b6:	4567b783          	ld	a5,1110(a5) # c08 <freep>
 ...
 7e4:	00e6ea63          	bltu	a3,a4,7f8 <free+0x50>
{
 ...
 826:	3ef73323          	sd	a5,998(a4) # c08 <freep>
}
 82a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 858:	3b453503          	ld	a0,948(a0) # c08 <freep>
 ...
 880:	38c90913          	addi	s2,s2,908 # c08 <freep>
  if(p == (char*)-1)
 884:	5afd                	li	s5,-1
 886:	a88d                	j	8f8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 888:	00000797          	auipc	a5,0x0
 88c:	39078793          	addi	a5,a5,912 # c18 <base>
 890:	00000717          	auipc	a4,0x0
 894:	36f73c23          	sd	a5,888(a4) # c08 <freep>
 898:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8ba:	34a73923          	sd	a0,850(a4) # c08 <freep>
      return (void*)(p + 1);
...
struct thread *thread_create(void (*f)(void *), void *arg){
 ...
 9c4:	24470713          	addi	a4,a4,580 # c04 <id>
 9c8:	431c                	lw	a5,0(a4)
...
void thread_add_runqueue(struct thread *t){
 ...
 9f8:	21c7b783          	ld	a5,540(a5) # c10 <current_thread>
 ...
 a06:	efc8                	sd	a0,152(a5)
        t->next = current_thread;
 a08:	f15c                	sd	a5,160(a0)
    }
}
 a0a:	6422                	ld	s0,8(sp)
 ...
 a14:	20a7b023          	sd	a0,512(a5) # c10 <current_thread>
        current_thread->previous = t;
...
void schedule(void){
 ...
 a28:	1ec78793          	addi	a5,a5,492 # c10 <current_thread>
 a2c:	6398                	ld	a4,0(a5)
...
void thread_exit(void){
 ...
 a48:	1cc7b783          	ld	a5,460(a5) # c10 <current_thread>
 a4c:	73d8                	ld	a4,160(a5)
 a4e:	04e78363          	beq	a5,a4,a94 <thread_exit+0x5c>
        // free its stack
        free(current_thread->stack);
 a52:	6b88                	ld	a0,16(a5)
 a54:	00000097          	auipc	ra,0x0
 a58:	d54080e7          	jalr	-684(ra) # 7a8 <free>

        // remove thread from CLL
        current_thread->next->previous = current_thread->previous;
 a5c:	00000497          	auipc	s1,0x0
 a60:	1b448493          	addi	s1,s1,436 # c10 <current_thread>
 a64:	6088                	ld	a0,0(s1)
 a66:	7158                	ld	a4,160(a0)
 a68:	6d5c                	ld	a5,152(a0)
 a6a:	ef5c                	sd	a5,152(a4)
        current_thread->previous->next = current_thread->next;
 a6c:	0a053903          	ld	s2,160(a0)
 a70:	0b27b023          	sd	s2,160(a5)

        // free current thread
        struct thread *next_thread = current_thread->next;
        free(current_thread);
 a74:	00000097          	auipc	ra,0x0
 a78:	d34080e7          	jalr	-716(ra) # 7a8 <free>
 ...
 a84:	048080e7          	jalr	72(ra) # ac8 <dispatch>
        current_thread = NULL;
 ...
 a92:	8082                	ret
        free(current_thread->stack);
 a94:	6b88                	ld	a0,16(a5)
 a96:	00000097          	auipc	ra,0x0
 a9a:	d12080e7          	jalr	-750(ra) # 7a8 <free>
        free(current_thread);
 a9e:	00000497          	auipc	s1,0x0
 aa2:	17248493          	addi	s1,s1,370 # c10 <current_thread>
 aa6:	6088                	ld	a0,0(s1)
 aa8:	00000097          	auipc	ra,0x0
 aac:	d00080e7          	jalr	-768(ra) # 7a8 <free>
        current_thread = NULL;
 ab0:	0004b023          	sd	zero,0(s1)
        longjmp(env_st, 1);
 ab4:	4585                	li	a1,1
 ab6:	00000517          	auipc	a0,0x0
 aba:	17250513          	addi	a0,a0,370 # c28 <env_st>
 abe:	00000097          	auipc	ra,0x0
 ac2:	e8e080e7          	jalr	-370(ra) # 94c <longjmp>
}
 ac6:	b7c9                	j	a88 <thread_exit+0x50>

0000000000000ac8 <dispatch>:
void dispatch(void){
 ...
 ad4:	14053503          	ld	a0,320(a0) # c10 <current_thread>
 ad8:	09452783          	lw	a5,148(a0)
 adc:	e7b9                	bnez	a5,b2a <dispatch+0x62>
        if(setjmp(current_thread->env)) {
 ade:	02050513          	addi	a0,a0,32
 ae2:	00000097          	auipc	ra,0x0
 ae6:	e32080e7          	jalr	-462(ra) # 914 <setjmp>
 aea:	cd01                	beqz	a0,b02 <dispatch+0x3a>
            current_thread->fp(current_thread->arg);
 aec:	00000797          	auipc	a5,0x0
 af0:	1247b783          	ld	a5,292(a5) # c10 <current_thread>
 af4:	6398                	ld	a4,0(a5)
 af6:	6788                	ld	a0,8(a5)
 af8:	9702                	jalr	a4
            thread_exit();
 afa:	00000097          	auipc	ra,0x0
 afe:	f3e080e7          	jalr	-194(ra) # a38 <thread_exit>
        current_thread->env->sp = (unsigned long)current_thread->stack_p;
 b02:	00000517          	auipc	a0,0x0
 b06:	10e53503          	ld	a0,270(a0) # c10 <current_thread>
 b0a:	6d1c                	ld	a5,24(a0)
 b0c:	e55c                	sd	a5,136(a0)
        current_thread->buf_set = 1;
 b0e:	4785                	li	a5,1
 b10:	08f52a23          	sw	a5,148(a0)
        longjmp(current_thread->env, 1);
 b14:	4585                	li	a1,1
 b16:	02050513          	addi	a0,a0,32
 b1a:	00000097          	auipc	ra,0x0
 b1e:	e32080e7          	jalr	-462(ra) # 94c <longjmp>
}
 b22:	60a2                	ld	ra,8(sp)
 b24:	6402                	ld	s0,0(sp)
 ...
 b28:	8082                	ret
        longjmp(current_thread->env, 1);        
 b2a:	4585                	li	a1,1
 b2c:	02050513          	addi	a0,a0,32
 b30:	00000097          	auipc	ra,0x0
 b34:	e1c080e7          	jalr	-484(ra) # 94c <longjmp>
}
 b38:	b7ed                	j	b22 <dispatch+0x5a>

0000000000000b3a <thread_yield>:
void thread_yield(void){
 ...
 b46:	0ce53503          	ld	a0,206(a0) # c10 <current_thread>
 b4a:	02050513          	addi	a0,a0,32
 b4e:	00000097          	auipc	ra,0x0
 b52:	dc6080e7          	jalr	-570(ra) # 914 <setjmp>
 b56:	c509                	beqz	a0,b60 <thread_yield+0x26>
}
 b58:	60a2                	ld	ra,8(sp)
 b5a:	6402                	ld	s0,0(sp)
 ...
 b64:	ebe080e7          	jalr	-322(ra) # a1e <schedule>
    dispatch();
 b68:	00000097          	auipc	ra,0x0
 b6c:	f60080e7          	jalr	-160(ra) # ac8 <dispatch>
 b70:	b7e5                	j	b58 <thread_yield+0x1e>

0000000000000b72 <thread_start_threading>:
void thread_start_threading(void){   
 b72:	1141                	addi	sp,sp,-16
 b74:	e406                	sd	ra,8(sp)
 b76:	e022                	sd	s0,0(sp)
 b78:	0800                	addi	s0,sp,16
 ...
 b7e:	0ae50513          	addi	a0,a0,174 # c28 <env_st>
 b82:	00000097          	auipc	ra,0x0
 b86:	d92080e7          	jalr	-622(ra) # 914 <setjmp>
 b8a:	c509                	beqz	a0,b94 <thread_start_threading+0x22>
        return;
    schedule();
    dispatch();
}
 ...
 b98:	e8a080e7          	jalr	-374(ra) # a1e <schedule>
    dispatch();
 b9c:	00000097          	auipc	ra,0x0
 ba0:	f2c080e7          	jalr	-212(ra) # ac8 <dispatch>
 ba4:	b7e5                	j	b8c <thread_start_threading+0x1a>
